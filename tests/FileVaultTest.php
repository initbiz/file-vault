...
namespace Initbiz\FileVault\Tests;

use Initbiz\FileVault\Facades\FileVault;
use Initbiz\FileVault\FileVaultServiceProvider;
...
class FileVaultTest extends TestCase
{
    ...
    protected function generateRandomKey()
    {
        return 'base64:'.base64_encode(
            \Initbiz\FileVault\FileVault::generateKey()
        );
    }
